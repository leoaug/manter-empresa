...
@Transactional(value = "transactionManagerTecnotour")
public class DAO <T extends Serializable> extends BBTSGenericDAO <T> implements Serializable  {

private static final long serialVersionUID = 1L;
	
	@PersistenceContext(unitName = "tecnotour")
	private EntityManager entityManager;
	
	@PostConstruct
	public void init() throws ClassNotFoundException, Exception{
		super.setEntityManager(this.entityManager);
		super.setClazzForName ((Class<T>) Class.forName(BBTSClassUtil.getCanonicalNamePorTipoGenericsSadc(this.getClass(),"br.com.bb.amb.tecnotour.modelo.entidade")));
