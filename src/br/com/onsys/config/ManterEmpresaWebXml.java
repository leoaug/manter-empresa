...
import br.com.onsys.bean.ManterEmpresaPostProcessor;

@Configuration
@EnableWebMvc
@EnableAspectJAutoProxy(proxyTargetClass = true)
@ComponentScan(basePackages = { "br.com.onsys.*","br.com.onsys.converter.*" })
public class ManterEmpresaWebXml implements WebApplicationInitializer, WebMvcConfigurer {
    public void onStartup(final ServletContext servletContext) throws ServletException {
        final AnnotationConfigWebApplicationContext appContext = new AnnotationConfigWebApplicationContext();
        appContext.register(new Class[] { ManterEmpresaWebXml.class });
    ...
    protected void inicializarParametros(final ServletContext servletContext) {
        ...
        servletContext.setInitParameter("primefaces.THEME", "ecuador-blue");
        servletContext.setInitParameter("primefaces.FONT_AWESOME", "true");
        servletContext.setInitParameter("javax.faces.FACELETS_BUFFER_SIZE", "65535");
    }
    
    @Bean
    public static ManterEmpresaPostProcessor tecnotourPostProcessor() {
        return new ManterEmpresaPostProcessor();
    }
